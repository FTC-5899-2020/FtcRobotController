package org.firstinspires.ftc.teamcode.TestPrograms.Odometry;
...
public class OdometryCalibration extends LinearOpMode {
    ...
    //Hardware Map Names for drive motors and odometry wheels. THIS WILL CHANGE ON EACH ROBOT, YOU NEED TO UPDATE THESE VALUES ACCORDINGLY -- Updated by Liam and Justin
    String rfName = "motorFwdRight", rbName = "motorBackRight", lfName = "motorFwdLeft", lbName = "motorBackLeft";
    String verticalLeftEncoderName = rbName, verticalRightEncoderName = lfName, horizontalEncoderName = rfName;

    final double PIVOT_SPEED = 0.5;

    //The amount of encoder ticks for each inch the robot moves. THIS WILL CHANGE FOR EACH ROBOT AND NEEDS TO BE UPDATED HERE -- Not updated by Liam and Justin
